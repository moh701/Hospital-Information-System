                    ...
                    <div class="mt-5 card wow fadeIn" data-wow-delay="0.4s">
                        <div class="card-body">
                            <form action="" class="login" id="login" >
                                ...
                                <div class="md-form">
                                    <i class="fa fa-lock prefix white-text"></i>
                                    <input name="vercode" type="text" id="orangeForm-pass" class="form-control">
                                    <label for="orangeForm-pass">Your validation code</label>
                                </div>
                                ...
                                <div class="text-center">
                                    <button onclick="submitForm()" name="btn" class="btn blue-gradient btn-lg">Sign In</button>
                                    <hr>
